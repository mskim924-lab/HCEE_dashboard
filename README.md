...
| TC-03 | \|PXI − EXI\| > 15 | Cross-domain rebalance              | Normal gap 4–6 (empirical) → HRO cross-domain decoupling (Reason 1997) |
...
| IF    | Information Flow            | 1.00 → 1.20 (+20%) | AAL inverse-symmetric     |
...
`EXI shock` 버튼 클릭. EXI만 -15 충격 (PXI는 그대로) → 격차 15 초과 → TC-03 발화. S4 시나리오 실시간 재현.
