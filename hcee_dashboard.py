...
with tab_ai:
    ...
    for _ai, _st_en, _st_kr, _color, _sym, _stats, _eff_aal in _ai_details:
        ...
        # Keep slider synced to auto value when not manually overridden, so
        # the widget reflects automatic governance adjustment. Set BEFORE the
        # slider widget is instantiated below — safe.
        if not _is_manual:
